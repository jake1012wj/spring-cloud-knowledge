package com.jeesite.modules.blog.xo.utils;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.jeesite.modules.blog.admin.annotion.AuthorityVerify.AuthorityVerifyAspect;
...
import com.jeesite.modules.blog.xo.service.SystemConfigService;
...
public class WebUtil {
    ...
    public <T> T getData(String result, Class<T> beanType) {
        if (com.jeesite.modules.blog.utils.StringUtils.isEmpty(result)) {
            return null;
        }
