package com.jeesite.modules.blog.picture.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.jeesite.modules.blog.commons.entity.File;
import com.jeesite.modules.blog.commons.entity.FileSort;
import com.jeesite.modules.blog.commons.entity.SystemConfig;
import com.jeesite.modules.blog.picture.global.MessageConf;
import com.jeesite.modules.blog.picture.global.SQLConf;
import com.jeesite.modules.blog.picture.global.SysConf;
import com.jeesite.modules.blog.picture.mapper.FileMapper;
import com.jeesite.modules.blog.picture.service.*;
import com.jeesite.modules.blog.picture.util.AboutFileUtil;
import com.jeesite.modules.blog.picture.util.FeignUtil;
import com.jeesite.modules.blog.picture.util.QiniuUtil;
...
import com.jeesite.modules.blog.base.enums.EFilePriority;
...
public class FileServiceImpl extends SuperServiceImpl<FileMapper, File> implements FileService {
    ...
    public String getPicture(String fileIds, String code) {
        ...
        if (StringUtils.isEmpty(fileIds)) {
            ...
            QueryWrapper<com.jeesite.modules.blog.commons.entity.File> queryWrapper = new QueryWrapper<>();
            queryWrapper.in(SQLConf.UID, changeStringToString);
            List<com.jeesite.modules.blog.commons.entity.File> fileList = fileService.list(queryWrapper);
            if (fileList.size() > 0) {
                for (com.jeesite.modules.blog.commons.entity.File file : fileList) {
                    if (file != null) {
    ...
    public String batchUploadFile(HttpServletRequest request, List<MultipartFile> filedatas, SystemConfig systemConfig) {
        ...
        if (filedatas != null && filedatas.size() > 0) {
            for (MultipartFile filedata : filedatas) {
                ...
                // 检查是否是安全的格式
                if (!FileUtils.isSafe(picExpandedName)) {
    ...
    public String uploadPictureByUrl(FileVO fileVO) {
        ...
        List<com.jeesite.modules.blog.commons.entity.File> lists = new ArrayList<>();
        //文件上传
        if (urlList != null && urlList.size() > 0) {
            for (String itemUrl : urlList) {
                ...
                com.jeesite.modules.blog.commons.entity.File file = new com.jeesite.modules.blog.commons.entity.File();
                file.setCreateTime(new Date(System.currentTimeMillis()));
                file.setFileSortUid(fileSort.getUid());
