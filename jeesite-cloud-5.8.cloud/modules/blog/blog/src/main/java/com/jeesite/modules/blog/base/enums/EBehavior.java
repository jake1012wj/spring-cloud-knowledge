package com.jeesite.modules.blog.base.enums;

import com.jeesite.modules.blog.base.handler.RestExceptionHandler;
...
public enum EBehavior {
    ...
    private static Logger log = LoggerFactory.getLogger(EBehavior.class);
