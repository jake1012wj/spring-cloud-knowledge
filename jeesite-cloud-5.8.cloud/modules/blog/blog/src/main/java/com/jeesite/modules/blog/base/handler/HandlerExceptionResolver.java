package com.jeesite.modules.blog.base.handler;

import com.jeesite.modules.blog.base.exception.exceptionType.*;
import com.jeesite.modules.blog.base.global.BaseMessageConf;
...
public class HandlerExceptionResolver implements org.springframework.web.servlet.HandlerExceptionResolver {
    private static Logger log = LoggerFactory.getLogger(HandlerExceptionResolver.class);
    /**
     * 异常处理方法
     *
     * @param request
